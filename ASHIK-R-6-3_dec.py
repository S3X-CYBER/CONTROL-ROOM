...
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m TOOLS\033[1;91m        \033[1;91m: \033[1;92m FREE\033[1;91m-\033[1;92mNO PIAD                     \033[1;91m|
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/S3X-CYBER/CONTROL-ROOM/blob/main/Approval.txt').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      print(' \x1b[1;91m[3] THIS TOOL ID DAILY UPDATE')
      print(' \033[1;92m[4] DATA WORKING 100% ')
      print(' \x1b[1;93m[𝟸] CP ID LOGIN 50%')
      print(' \x1b[1;94m[𝟸] WI-FI WORKING 80%')
      print(" \x1b[0m[𝟸] YOUR KEY : "+id)
      input(' \033[1;30m[𝟹] IF U WANT TO FREE NEED THEN PRESS ENTER ')
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801766383498?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
os.system('espeak -a 300 " Welcome,   to,  SAMI,  FREE,  Tools"')
def back():
	login()
